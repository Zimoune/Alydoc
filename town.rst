...
Les parcelles
-------------
Une ville est composée de parcelles (plots). Ces plots permettent de délimiter votre territoire.
Un plot est de dimension 16x16.

Chaque ville possède un nombre maximum de plots, montant qui relatif au nombre de joueurs résidant dans la ville. 
Les habitants n'ont aucune limite sur le nombre de plots qu'ils peuvent possèder.
...
Le bloc où vous executerez la commande sera le plot principale de votre ville. 

.. warning:: ⚠ Vous devez immédiatement mettre de l'argent dans la banque de votre ville (en utilisant ``/t deposit <montant>``) 
             afin qu'elle ne soit pas perdue lors de la prochaine collecte de taxe journalière.

Vous pouvez ensuite étendre votre ville en achetant les plots voisins.
